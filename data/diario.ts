/**
 * Fuente única de contenido para el sitio "Diario Lúdico".
 *
 * El cuerpo textual se transcribió desde "Diario Lúdico.pdf" sin correcciones
 * de estilo, puntuación ni ortografía.
 */
...
export const SITE = {
  ...
  school: 'institución educativa pública',
  city: 'Medellín',
  location: 'institución educativa pública de la ciudad de Medellín',
  program: 'Diario Lúdico',
  seminar: 'Diario Lúdico',
  credit: 'Diario Lúdico',
  meta: 'Presentación',
} as const
...
export const PRESENTATION = {
  ...
  title: 'Diario Lúdico:',
  paragraphs: [
    'Mi nombre es Santiago Londoño. Soy docente de lengua castellana y filosofía en una institución educativa pública de la ciudad de Medellín. Vivo entre dos mundos que dialogan constantemente: el de la escuela y el de la lectura; el de la reflexión académica y el de las experiencias cotidianas que surgen en el encuentro con los estudiantes.',
...
export const DIARY: DiaryDay[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'Esta experiencia me permitió reflexionar sobre la importancia del diálogo. Ver a los estudiantes debatir, disentir y buscar puntos de encuentro me recordó que la educación sigue siendo uno de los escenarios privilegiados para aprender a convivir con la diferencia. Creo que esa es una de las misiones fundamentales para construir sociedad. A pesar de que hoy la lúdica apareció menos en el cuerpo y más en el pensamiento, creo en la posibilidad de jugar con las ideas, cuestionarlas y reconstruirlas junto a otros, esa es otra forma de la lúdica.',
    ],
  },
  {
    id: 'miercoles',
    ...
    paragraphs: [
      ...
      'Al finalizar el día pensé en cómo el juego puede convertirse en una herramienta para resignificar la experiencia escolar. Lo que para algunos estudiantes podría haber sido una clase más de lectura crítica terminó convirtiéndose en una aventura compartida. Hoy confirmé una idea presente en las lecturas del módulo y es que la lúdica fortalece el vínculo, la comunicación y la esperanza, porque permite que el aprendizaje ocurra desde la participación activa, el encuentro con los otros y la experiencia directa.',
    ],
  },
  {
    id: 'jueves',
    ...
    paragraphs: [
      ...
      'Al finalizar la jornada pensé que la lúdica posee una enorme capacidad para acercar a los estudiantes al conocimiento. Tanto la lectura compartida de la mañana como el juego de la otra clase, demostraron que aprender no implica necesariamente permanecer inmóvil o recibir información de manera pasiva. La imaginación, la interpretación, el diálogo y el juego pueden convertir el aprendizaje en una experiencia más significativa. Hoy confirmé que cuando los estudiantes participan activamente, el conocimiento deja de ser una obligación y comienza a sentirse como un descubrimiento.',
      '** Nota mental: Debo cultivar la capacidad de asombro en mis estudiantes, Recuerdo a Freire cuando decía que los sentidos también se educan, cabe preguntarse entonces ¿Qué asombra a un adolescente? ¿Qué tipo de personas admiran y por qué? ¿Cómo lograr que las clases que imparto se conviertan en un pequeño Aleph que les permita ver la realidad para querer transformarla?',
    ],
  },
  {
    id: 'viernes',
...
export const REFLECTION = {
  ...
  paragraphs: [
    ...
    'Al finalizar esta experiencia concluyo que la lúdica está presente cuando jugamos, pero también cuando imaginamos, dialogamos, creamos, reflexionamos, reímos o soñamos. Tal vez educar sea precisamente abrir pequeños espacios donde, a pesar de las dificultades, siga siendo posible jugar con las ideas, imaginar otros mundos y creer que la realidad puede transformarse. Como si la escuela fuera un submundo para la oportunidad, para imaginarse otras realidades donde la felicidad sea bandera y el aprender una consecuencia del asombro.',
  ],
} as const
